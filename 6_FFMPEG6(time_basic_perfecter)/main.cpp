...
int main(int argc,char *argv[])
{
    ...
    AudioOutput *audio_output = new AudioOutput(&avsync, demux_thread->AudioStreamTimebase(), audio_prams, &audio_frame_queue);
    ...
    video_output *video_output_ = new  video_output(&avsync, demux_thread->VideoStreamTimebase(),&video_frame_queue, demux_thread->VideoCodecParameters()->width,
